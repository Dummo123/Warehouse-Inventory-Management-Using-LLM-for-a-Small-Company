...
* \[x] **10–14 (июль):** БД, ORM-модели, FastAPI бэкенд, импорт данных из Excel — **чекпоинт #1**
* \[ ] **24–28 (июль):** React фронтенд — таблицы, формы, графики движений
* \[ ] **7–10 (август):** LLM-помощник (Ollama + RAG, 5 вопросов по ТЗ)
* \[ ] **20–24 (август):** Тестирование, деплой на сервер, финансовый модуль, документация
